...
<template>
  <header class="w-full z-30 bg-gradient-to-r from-pink-500 to-purple-600" id="header-section-container">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 bg-opacity-30 backdrop-filter backdrop-blur-lg rounded-lg shadow-lg">
        ...
        <div class="md:hidden flex items-center ml-4">
          ...
          >
            <ul id="mobile-nav-list" class="border border-transparent rounded-lg px-4 py-1.5 bg-gradient-to-r from-pink-500 to-purple-600 bg-opacity-70 backdrop-filter backdrop-blur-lg">
              ...
              <li>
                <a id="mobile-Services-link" class="flex font-medium text-sm py-1.5 text-white hover:text-pink-200" href="Services.html">Services</a>
              </li>
              <li>
